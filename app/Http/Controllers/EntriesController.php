...
class EntriesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'childMiddleName' => 'required|alpha',
            'childLastNam' => 'required|alpha',
            'motherFirstName' => 'required|alpha',
            'motherMiddleName' => 'required|alpha',
            'motherLastName' => 'required|alpha',
            'fatherFirstName' => 'required|alpha',
            'fatherMiddleName' => 'required|alpha',
            'fatherLastName' => 'required|alpha',
